...
<footer class="hidden md:block p-4 bg-gray-100 rounded-lg shadow px-6 py-8 dark:bg-gray-900">
    <div class="flex items-center justify-between">
        <a href="../index.php" class="flex items-center mb-0">
            <img src="./assets/Images/Icon.png" class="h-8 mr-3" />
            <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Ricardo Industry's</span>
        </a>
        <ul class="flex flex-wrap items-center mb-6 text-sm text-gray-500 dark:text-gray-400">
            <li>
                <a href="minhaconta.php" class="mr-4 hover:underline md:mr-6 ">Minha Conta</a>
            </li>
            <li>
                <a href="encomendas.php" class="mr-4 hover:underline md:mr-6">Encomendas</a>
            </li>
        </ul>
    </div>
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex mt-4 space-x-6 justify-center :mt-0">
            ...
            <a href="https://www.linkedin.com/in/ricardo-domingos-535134252/" class="text-gray-500 hover:text-gray-900 dark:hover:text-white" target="_blank">
...
<!-- Footer Desktop End -->
<!-- Footer Mobile Start -->
<footer class="md:hidden p-4 bg-white rounded-lg shadow dark:bg-gray-900">
    <div>
        ...
        <ul class="flex flex-wrap items-center mb-6 text-sm text-gray-500 dark:text-gray-400">
            <li>
                <a href="minhaconta.php" class="mr-4 hover:underline">Minha Conta</a>
            </li>
            <li>
                <a href="encomendas.php" class="mr-4 hover:underline">Encomendas</a>
            </li>
        </ul>
    </div>
